<?php
	$lang = array(
        ...
        "general manager" => "GENERAL MANAGER",
        "technical adviser 1" => "TECHNICAL ADVISER N˚1",
        "director of internal audit" => "DIRECTOR OF INTERNAL AUDIT",
        "chief compliance officer" => "CHIEF COMPLIANCE OFFICER",
        "director of legal" => "Director of LEGAL AFFAIRS AND LITIGATION DIVISION",
        "chief info" => "CHIEF INFORMATION OFFICER",
        "technical director" => "TECHNICAL DIRECTOR ",
        "director of research" => "DIRECTOR OF RESEARCH, MONITORING AND PETROLEUM STATISTICS ",
        "director finance" => "DIRECTOR OF FINANCE, ACCOUNTING AND DEBT RECOVERY",
        "director human" => "DIRECTOR OF HUMAN RESOURCES AND GENERAL OPERATIONS",
        "douala head" => "HEAD OF THE DOUALA BRANCH OFFICE",
        "hpsf" => "hpsf",
        "hpsf" => "hpsf",
        "hpsf" => "hpsf",
		"lang_en" => "English",
